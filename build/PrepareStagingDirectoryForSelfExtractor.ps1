...
.PARAMETER $IsLocalized
    True if the localized output have been generated for the build, false otherwise,
    as is the case with builds generated by GitHub Actions.
#>
